...
(
	...
	[CREATINGDATE] DATETIMEOFFSET DEFAULT SYSDATETIMEOFFSET(),
	[WIDTH] REAL NOT NULL,
	[HEIGHT] REAL NOT NULL,
	[LENGTH] REAL NOT NULL,
) ON [PRIMARY];
GO
ALTER TABLE [STOREHOUSE].[PRODUCTVERSION] ADD CONSTRAINT STOREHOUSE_PRODUCTVERSION_WIDTH_POSITIVE CHECK([WIDTH] > 0);
GO
ALTER TABLE [STOREHOUSE].[PRODUCTVERSION] ADD CONSTRAINT STOREHOUSE_PRODUCTVERSION_HEIGHT_POSITIVE CHECK([HEIGHT] > 0);
GO		    
ALTER TABLE [STOREHOUSE].[PRODUCTVERSION] ADD CONSTRAINT STOREHOUSE_PRODUCTVERSION_LENGTH_POSITIVE CHECK([LENGTH] > 0);
GO
ALTER TABLE [STOREHOUSE].[PRODUCTVERSION] ADD CONSTRAINT STOREHOUSE_PRODUCTVERSION_ID_PK PRIMARY KEY([ID] ASC);
GO
ALTER TABLE [STOREHOUSE].[PRODUCTVERSION] ADD CONSTRAINT STOREHOUSE_PRODUCTVERSION_PRODUCT_ID_FK
	FOREIGN KEY ([PRODUCT_ID]) REFERENCES [STOREHOUSE].[PRODUCT]([ID])
		ON DELETE CASCADE;
GO
